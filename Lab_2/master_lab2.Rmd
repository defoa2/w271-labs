...
```
```{r}
co2_present_mnth <- na_locf(co2_present_mnth)
```
...
co2_present_mnth$sa_co2_level <- sa_noaa_data$time.series[, "seasonal"]
...
ns_pseudo_out_sample <- values_ns_forecast - sa_test$value
sa_pseudo_out_sample <- values_sa_forecast - sa_test$value
