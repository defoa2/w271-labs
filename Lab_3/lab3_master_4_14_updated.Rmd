...
cat("Estimated increase in traffic fatalities during the COVID boom:", (exp(fatalities_increase_boom) - 1)*100, "%", "\n")
...
cat("Estimated decrease in traffic fatalities during the COVID bust:", (exp(fatalities_decrease_bust) - 1)*100, "%", "\n")
